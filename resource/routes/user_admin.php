...
$app->group('/user', function ($app) use ($container) {
    ...
    $app->get("/order/view/{order_number}","App\Controllers\UserPanelController:get_order_details");
    ...
    $app->post('/order-payment/{order_number}', "App\Controllers\UserPanelController:order_payment");
