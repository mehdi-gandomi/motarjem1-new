...
$app->group('/translator', function ($app) use ($container) {
    ...
    $app->group('',function($app) use ($container){
        ...
        $app->post("/orders/upload-completed-files","App\Controllers\TranslatorPanelController:upload_completed_order_files");
        $app->post("/orders/set-complete","App\Controllers\TranslatorPanelController:set_order_as_completed");
